...
const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(specifiedDate, 'MM/dd/yyyy');

//                       (title, description, dueDate, completionStatus, important, project)
let testing = new _tasks__WEBPACK_IMPORTED_MODULE_0__.Task('title1', 'description1', formattedDate, true, true, 'project1');
