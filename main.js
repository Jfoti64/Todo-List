...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"CAAC;IACG,YAAY;IACZ,SAAS;IACT,aAAa;IACb,iCAAiC;AACrC;;;AAGA;IACI,aAAa;IACb,SAAS;IACT,kCAAkC;AACtC;;AAEA;IACI,aAAa;IACb,8BAA8B;AAClC;;AAEA;IACI,aAAa;IACb,kCAAkC;IAClC,uBAAuB;AAC3B;;AAEA;IACI,YAAY;IACZ,YAAY;AAChB;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,aAAa;IACb,SAAS;AACb;;AAEA;IACI,YAAY;IACZ,mCAAmC;IACnC,aAAa;IACb,0CAA0C;IAC1C,kCAAkC;IAClC,uBAAuB;AAC3B;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,aAAa;IACb,+BAA+B;IAC/B,YAAY;AAChB;;AAEA;IACI,cAAc;IACd,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,uBAAuB;;AAE3B","sourcesContent":[" body {\n    height: 100%;\n    margin: 0;\n    display: grid;\n    grid-template-rows: auto 1fr auto;\n}\n\n\nbody {\n    display: grid;\n    height: 1;\n    grid-template-rows: 80px 100% 50px;\n}\n\n#centerContent {\n    display: grid;\n    grid-template-columns: 1fr 5fr;\n}\n\n#leftColumn {\n    display: grid;\n    grid-template-rows: repeat(6, 1fr);\n    border: black solid 5px;\n}\n\n#leftColumn button {\n    height: 50px;\n    width: 150px;\n}\n\ndiv {\n    background-color: #d61313;\n}\n\nheader {\n    background-color: blue;\n}\n\nh3 {\n    font-size: 3rem;\n}\n\n.taskCard h5, .taskCard p {\n    margin: 0px;\n}\n\n#currentTasks {\n    display: grid;\n    gap: 10px;\n}\n\n.taskCard {\n    height: 90px;\n    background-color: rgb(123, 44, 180);\n    display: grid;\n    grid-template-columns: 25px repeat(4, 1fr);\n    grid-template-rows: repeat(2, 1fr);\n    border: solid black 3px;\n}\n\n.completionStatus {\n    grid-row: 1 / -1;\n}\n\n.description, .dueDate {\n    grid-row: 2;\n}\n\n#addTaskDiv {\n    display: grid;\n    grid-template-columns: 25px 1fr;\n    height: 90px;\n}\n\n#addTaskInput {\n    grid-column: 2;\n    width: 100%;\n    height: 80px;\n}\n\nfooter {\n    background-color: green;\n\n}\n\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   addEventListenerDueDate: () => (/* binding */ addEventListenerDueDate),
    ...
    addTaskInput.addEventListener('keypress', event => {
        if (event.key === 'Enter') {
            if (addTaskInput.value !== '') {
                ...
                const formattedCurrentDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(new Date(), 'MM/dd/yyyy');
...
function displayDueTodayTab() {
    const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(new Date(), "MM/dd/yyyy");
    const allTasks = (0,_getTasksFromStorage__WEBPACK_IMPORTED_MODULE_0__.getTasksFromStorage)();
    clearDom();
...
function createNewTaskCard(obj) {
    ...
    _addEventListeners__WEBPACK_IMPORTED_MODULE_1__.addEventListenerDueDate(dueDate);
