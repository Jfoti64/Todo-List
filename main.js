...
function displayDueTodayTab() {
    const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(new Date(), "MM/dd/yyyy");
...
_displayTasks__WEBPACK_IMPORTED_MODULE_5__.displayDueTodayTab();
