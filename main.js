...
let formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.format)(new Date(2014, 1, 11), "MM/dd/yyyy");
let testing = new _tasks__WEBPACK_IMPORTED_MODULE_5__.Task('title1', 'description1', formattedDate, true, true, 'project1');
