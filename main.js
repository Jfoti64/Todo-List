...
function addEventListenerEditDueDate(editDueDate, taskIndex) {
    editDueDate.addEventListener('change', function() {
        ...
        _changeTaskProperty__WEBPACK_IMPORTED_MODULE_0__.editDueDate(taskIndex, this.value)
    });
}
    ...
    addTaskInput.addEventListener('keypress', event => {
        if (event.key === 'Enter') {
            if (addTaskInput.value !== '') {
                ...
                const formattedCurrentDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(new Date(), 'yyyy-MM-dd');
                const inputValue = event.target.value;
                if (projectName.innerHTML == 'All') {
                    new _tasks__WEBPACK_IMPORTED_MODULE_1__.Task(inputValue, 'description', formattedCurrentDate, false, false, '');
                    _displayTasks__WEBPACK_IMPORTED_MODULE_2__.displayAllTasksTab();
                }
                else {
                    new _tasks__WEBPACK_IMPORTED_MODULE_1__.Task(inputValue, 'description', formattedCurrentDate, false, false, projectName.innerHTML);
                }
...
const openEditPanel = (taskIndex, event) => {
    ...
    const formattedDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(new Date(taskInStorage.dueDate), 'yyyy-MM-dd');
