    ...
    addTaskInput.addEventListener('keypress', event => {
        if (event.key === 'Enter') {
            if (addTaskInput.value !== '') {
                const formattedCurrentDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(), 'MM/dd/yyyy');
