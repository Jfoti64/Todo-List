...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./images/yuriy-kovalev-nN1HSDtKdlw-unsplash.jpg */ "./src/images/yuriy-kovalev-nN1HSDtKdlw-unsplash.jpg"), __webpack_require__.b);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addEventListenerAddTaskInput: () => (/* binding */ addEventListenerAddTaskInput),
/* harmony export */   addEventListenerCompletionStatus: () => (/* binding */ addEventListenerCompletionStatus),
/* harmony export */   addEventListenerDeleteBtn: () => (/* binding */ addEventListenerDeleteBtn),
/* harmony export */   addEventListenerEditDueDate: () => (/* binding */ addEventListenerEditDueDate),
/* harmony export */   addEventListenerImportantToggle: () => (/* binding */ addEventListenerImportantToggle),
/* harmony export */   addEventListenerPanelTaskTitle: () => (/* binding */ addEventListenerPanelTaskTitle),
/* harmony export */   addEventListenerProjectCard: () => (/* binding */ addEventListenerProjectCard),
/* harmony export */   addEventListenerTaskCard: () => (/* binding */ addEventListenerTaskCard)
/* harmony export */ });
/* harmony import */ var _changeTaskProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./changeTaskProperty */ "./src/changeTaskProperty.js");
...
/* harmony import */ var _getTasksFromStorage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getTasksFromStorage */ "./src/getTasksFromStorage.js");
...
/* harmony import */ var _currentProject__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./currentProject */ "./src/currentProject.js");
...
function addEventListenerTaskCard(taskCard) {
    taskCard.addEventListener('click', (event) => {
        ...
        _displayTasks__WEBPACK_IMPORTED_MODULE_2__.openEditPanel(dataIndex, event);
    });
}

function addEventListenerProjectCard(projectCard) {
    projectCard.addEventListener('click' , () => {
        _currentProject__WEBPACK_IMPORTED_MODULE_4__.setCurrentProject(projectCard.innerHTML);
    })
}
...
function addEventListenerImportantToggle(toggleImportant, taskIndex) {
    ...
    toggleImportant._importantClickListener = () => {
        _changeTaskProperty__WEBPACK_IMPORTED_MODULE_0__.toggleImportant(taskIndex);
        const currentProjectState = _currentProject__WEBPACK_IMPORTED_MODULE_4__.getAppState().currentProject
        // Refresh current project
        _currentProject__WEBPACK_IMPORTED_MODULE_4__.setCurrentProject(currentProjectState);
    };
...
function addEventListenerEditDueDate(editDueDate, taskIndex) {
    ...
    editDueDate._changeEventListener = function() {
        ...
        const dateAtNoon = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.addHours)(date, 12);
        _changeTaskProperty__WEBPACK_IMPORTED_MODULE_0__.editDueDate(taskIndex, dateAtNoon);
        _displayTasks__WEBPACK_IMPORTED_MODULE_2__.editDueDateElement(taskIndex);
    };
...
function addEventListenerCompletionStatus(completionStatus) {
    completionStatus.addEventListener('click', () => {
        ...
        const dataIndex = taskCard.getAttribute('data-index');
        _changeTaskProperty__WEBPACK_IMPORTED_MODULE_0__.toggleCompletionStatus(dataIndex);
    });
}
...
function handleDeleteClick(taskIndex) {
    ...
    _changeTaskProperty__WEBPACK_IMPORTED_MODULE_0__.deleteTaskFromStorage(taskIndex);
}


document.addEventListener('DOMContentLoaded', function() {
    document.addEventListener('click', function(event) {
        _displayTasks__WEBPACK_IMPORTED_MODULE_2__.closeEditPanel(event);
        _displayTasks__WEBPACK_IMPORTED_MODULE_2__.closeProjectsPanel(event);
    });
});
...
document.addEventListener("DOMContentLoaded", function() {
    (function addEventListenerProjectsBtn() {
        ...
        hamburgerMenu.addEventListener('click', (event) => {
            _displayTasks__WEBPACK_IMPORTED_MODULE_2__.openProjectsPanel(event);
        });
    })();
});
...
(function addEventListenerAllTasksBtn() {
    ...
    allTasksTabBtn.addEventListener('click', () => {
        _currentProject__WEBPACK_IMPORTED_MODULE_4__.setCurrentProject('All');
    });
})();
...
(function addEventListenerTodayBtn() {
    ...
    todayTabBtn.addEventListener('click', () => {
            _currentProject__WEBPACK_IMPORTED_MODULE_4__.setCurrentProject('today');
    });
})();
...
(function addEventListenerImportantBtn() {
    ...
    importantTabBtn.addEventListener('click', () => {
        _currentProject__WEBPACK_IMPORTED_MODULE_4__.setCurrentProject('important');
    })
})();
...
(function addEventListenerAddProjectInput() {
    ...
    addProjectInput.addEventListener('keypress', event => {
        const projects = (0,_getTasksFromStorage__WEBPACK_IMPORTED_MODULE_3__.getProjectsFromStorage)();
        const inputValue = addProjectInput.value;
        if (event.key ==='Enter' && inputValue != '') {
            if (!projects.includes(inputValue)) {
                (0,_populateStorage__WEBPACK_IMPORTED_MODULE_5__.populateStorageProjects)(inputValue);
                _displayTasks__WEBPACK_IMPORTED_MODULE_2__.renderProjects();
...
function addEventListenerAddTaskInput() {
    addTaskInput.addEventListener('keypress', event => {
        ...
        const appState = _currentProject__WEBPACK_IMPORTED_MODULE_4__.getAppState().currentProject;
        if (event.key === 'Enter') {
            if (addTaskInput.value !== '') {
                const currentDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__.startOfToday)();
                const currentDateAtNoon = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.addHours)(currentDate, 12);
                const inputValue = event.target.value;
                if (appState == 'All') {
                    new _tasks__WEBPACK_IMPORTED_MODULE_1__.Task(inputValue, 'description', currentDateAtNoon, false, false, '');
                    _currentProject__WEBPACK_IMPORTED_MODULE_4__.renderTasksForProject(appState);
                }
                    ...
                    new _tasks__WEBPACK_IMPORTED_MODULE_1__.Task(inputValue, 'description', currentDateAtNoon, false, true, '');
                    _currentProject__WEBPACK_IMPORTED_MODULE_4__.renderTasksForProject(appState);
                }
                else {
                    new _tasks__WEBPACK_IMPORTED_MODULE_1__.Task(inputValue, 'description', currentDateAtNoon, false, false, appState);
                    _currentProject__WEBPACK_IMPORTED_MODULE_4__.renderTasksForProject(appState);
                }
                event.target.value = ''; // Clear the input field after submitting
            }
...
function handleTitleEditorBlur(taskIndex, inputElement) {
    ...
    _changeTaskProperty__WEBPACK_IMPORTED_MODULE_0__.editTitle(taskIndex, updatedTitle);
    // Refresh current project
    const currentProjectTab = _currentProject__WEBPACK_IMPORTED_MODULE_4__.getAppState().currentProject;
    _currentProject__WEBPACK_IMPORTED_MODULE_4__.setCurrentProject(currentProjectTab);
}
...
/* harmony export */ });
/* harmony import */ var _currentProject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./currentProject */ "./src/currentProject.js");
...
function updateTasksInStorage(updatedTasks) {
    ...
    const currentProjectTab = _currentProject__WEBPACK_IMPORTED_MODULE_0__.getAppState().currentProject;
    _currentProject__WEBPACK_IMPORTED_MODULE_0__.setCurrentProject(currentProjectTab);
}
...
function deleteTaskFromStorage(taskIndex) {
    ...
    const tasks = (0,_getTasksFromStorage__WEBPACK_IMPORTED_MODULE_1__.getTasksFromStorage)();
...
function editProject(taskIndex, newProject) {
    ...
    const projects = (0,_getTasksFromStorage__WEBPACK_IMPORTED_MODULE_1__.getProjectsFromStorage)();
...
/* harmony export */   getTasksForProject: () => (/* binding */ getTasksForProject),
/* harmony export */   renderTasksForProject: () => (/* reexport safe */ _displayTasks__WEBPACK_IMPORTED_MODULE_1__.renderTasksForProject),
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/isSameDay.mjs");
...
function setCurrentProject(projectName) {
    ...
    (0,_displayTasks__WEBPACK_IMPORTED_MODULE_1__.renderTasksForProject)(projectName);
}
...
function getTasksForProject(projectName) {
    ...
    if (projectName == 'All') {
        ...
        const tasksInProject = tasks.filter(task => (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.isSameDay)(task.dueDate, currentDate));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   closeEditPanel: () => (/* binding */ closeEditPanel),
/* harmony export */   closeProjectsPanel: () => (/* binding */ closeProjectsPanel),
/* harmony export */   editDueDateElement: () => (/* binding */ editDueDateElement),
/* harmony export */   openEditPanel: () => (/* binding */ openEditPanel),
/* harmony export */   openProjectsPanel: () => (/* binding */ openProjectsPanel),
/* harmony export */   renderProjects: () => (/* binding */ renderProjects),
/* harmony export */   renderTasksForProject: () => (/* binding */ renderTasksForProject)
/* harmony export */ });
/* harmony import */ var _getTasksFromStorage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getTasksFromStorage */ "./src/getTasksFromStorage.js");
...
/* harmony import */ var _icons_exclamation_mark_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./icons/exclamation-mark-svgrepo-com.svg */ "./src/icons/exclamation-mark-svgrepo-com.svg");
...
/* harmony import */ var _currentProject__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./currentProject */ "./src/currentProject.js");
/* harmony import */ var _icons_hamburger_menu_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./icons/hamburger-menu-svgrepo-com.svg */ "./src/icons/hamburger-menu-svgrepo-com.svg");
...
const hamburgerMenu = document.getElementById('hamburgerMenu');
hamburgerMenu.src = _icons_hamburger_menu_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_4__;
...
function renderTasksForProject(projectName) {
    ...
    const tasks = _currentProject__WEBPACK_IMPORTED_MODULE_3__.getTasksForProject(projectName);
...
function createAddTaskInput() {
    ...
    _addEventListeners__WEBPACK_IMPORTED_MODULE_1__.addEventListenerAddTaskInput();
}

function createProjectName() {
    const tasksContainer = document.getElementById('currentTasks');
    const projectName = document.createElement('h2');
    projectName.innerHTML = _currentProject__WEBPACK_IMPORTED_MODULE_3__.getAppState().currentProject;
    projectName.id = 'projectName';
    tasksContainer.appendChild(projectName);

    const currentDate = document.createElement('p');
    currentDate.id = 'currentDate';
    currentDate.innerHTML = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(new Date(), 'EEEE, LLL do yyyy');
...
function editDueDateElement(taskIndex) {
    ...
    const appState = _currentProject__WEBPACK_IMPORTED_MODULE_3__.getAppState().currentProject;
    if (taskCard) {
        const tasks = (0,_getTasksFromStorage__WEBPACK_IMPORTED_MODULE_0__.getTasksFromStorage)();
        const task = tasks[taskIndex];
        const currentDueDateElement = taskCard.querySelector('.dueDate');
        const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.parseISO)(task.dueDate);
        const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(date, 'yyyy-MM-dd');
        currentDueDateElement.innerHTML = formattedDate;
    } 
   
    _currentProject__WEBPACK_IMPORTED_MODULE_3__.renderTasksForProject(appState);
}
...
const openEditPanel = (taskIndex, event) => {
    ...
    _addEventListeners__WEBPACK_IMPORTED_MODULE_1__.addEventListenerImportantToggle(editImportance, taskIndex);
    _addEventListeners__WEBPACK_IMPORTED_MODULE_1__.addEventListenerEditDueDate(editDueDate, taskIndex);
    _addEventListeners__WEBPACK_IMPORTED_MODULE_1__.addEventListenerPanelTaskTitle(taskIndex, taskToEdit);
    _addEventListeners__WEBPACK_IMPORTED_MODULE_1__.addEventListenerDeleteBtn(deleteBtn, taskIndex);
...
function createNewProjectCard(project) {
    ...
    _addEventListeners__WEBPACK_IMPORTED_MODULE_1__.addEventListenerProjectCard(projectCard);
...
function createNewTaskCard(obj) {
    ...
    _addEventListeners__WEBPACK_IMPORTED_MODULE_1__.addEventListenerTaskCard(taskCard);
    ...
    _addEventListeners__WEBPACK_IMPORTED_MODULE_1__.addEventListenerCompletionStatus(completionStatus);
    ...
    dueDate.innerHTML = 'Due: ' + (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(obj.dueDate, 'EEEE, LLL do');
...
/* harmony export */   populateStorageProjects: () => (/* binding */ populateStorageProjects)
/* harmony export */ });
...
class Task {
    constructor(title, description, dueDate, completionStatus, important, project) {
        ...
        (0,_populateStorage__WEBPACK_IMPORTED_MODULE_1__.populateStorage)(this); // Add the task first
    }
}
...
/***/ "./src/icons/exclamation-mark-svgrepo-com.svg":
/*!****************************************************!*\
  !*** ./src/icons/exclamation-mark-svgrepo-com.svg ***!
  \****************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "5e95b8dfb071e37de6ea.svg";
...
module.exports = __webpack_require__.p + "dd54fc8737dc8f0276e8.svg";

/***/ }),

/***/ "./src/images/yuriy-kovalev-nN1HSDtKdlw-unsplash.jpg":
/*!***********************************************************!*\
  !*** ./src/images/yuriy-kovalev-nN1HSDtKdlw-unsplash.jpg ***!
  \***********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "836fbf3669b061b882c0.jpg";
